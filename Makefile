...
OBJS = $(PLUGIN).o serverthread.o tools.o info.o channels.o events.o recordings.o remote.o timers.o scraper2vdr/service.o statusmonitor.o osd.o jsonparser.o epgsearch.o searchtimers.o
CFGS = API.html
