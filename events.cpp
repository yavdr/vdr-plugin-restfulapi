...
void EventsResponder::replySearchResult(ostream& out, cxxtools::http::Request& request, cxxtools::http::Reply& reply)
{
  ...
  bool use_title = q.getOptionAsString("use_title") == "true";
  bool use_subtitle = q.getOptionAsString("use_subtitle") == "true";
  bool use_description = q.getOptionAsString("use_description") == "true";
